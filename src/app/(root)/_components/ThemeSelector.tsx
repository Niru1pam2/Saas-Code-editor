  ...
  return (
    <div className="relative" ref={dropdownref}>
      ...
      >
        ...
        <span className="text-gray-300 min-w-[60px] text-left group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute  left-0 mt-2 top-full w-full min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
          >
            ...
            {THEMES.map((t, idx) => (
              <motion.button
                ...
                className={`relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#262637] transition-all duration-200 ${theme === t.id ? "bg-blue-500/10 text-gray-400" : "text-gray-300"}`}
